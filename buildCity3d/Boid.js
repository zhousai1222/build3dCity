...
var Boid = function() {
	...
	_acceleration, _width = 1000, _height = 800, _depth = 1000, _goal, _neighborhoodRadius = 100,
	_maxSpeed = 2, _maxSteerForce = 0.1, _avoidWalls = false, minHeight = 100;
	...
	this.run = function ( boids ) {
		...
		if ( _avoidWalls ) {
			...
			vector.set( this.position.x, minHeight, this.position.z );
			vector = this.avoid( vector );
			vector.multiplyScalar( 5 );
			_acceleration.addSelf( vector );
